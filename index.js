...
async function fetchMarketData() {
  try {
    ...
    const _qdata = q?.data || {};const d = _qdata['NSE_INDEX%7CNifty%2050'] || _qdata['NSE_INDEX:Nifty 50'] || _qdata['NSE_INDEX: Nifty 50'] || _qdata[Object.keys(_qdata)[0]];
    if (d) {
    ...
    const daily = await upstox('GET',
      '/v2/historical-candle/NSE_INDEX%7CNifty%2050/day/2');
